...
public class CodeGenerator {
    ...
    public void run() {
        ...
        strategy.setTablePrefix(pc.getModuleName() + "_"); //生成实体类名时去掉表名前缀，只有模块名和表名前缀一致时才起作用
//        strategy.setTablePrefix("edu" + "_"); //生成实体类名时去掉表名前缀，只有模块名和表名前缀一致时才起作用
